from src.domain.ports.outbound.repository_protocol import GetRepositoryProtocol
...
class SwitchCartUseCase:
    def __init__(
            self, 
            repository: GetRepositoryProtocol, 
    ...
    def execute(self, 
        ...
        message = f"cart chance status: {new_status.value}"
